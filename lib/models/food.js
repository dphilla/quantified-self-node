...
const create = (food_params) => {
  console.log(food_params['food']['name'])
  console.log(food_params['food']['calories'])
  return database.raw('INSERT INTO foods (name, calories) VALUES (?, ?) RETURNING name, calories', //do we need to check for sql injection? (block ;)
